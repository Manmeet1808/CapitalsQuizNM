...
//
//        if (MainQuizAdapter.class.isInstance(this)) {
//
...
//                    submitButton.setOnClickListener(new MainQuizAdapter.ButtonClickListener());
//                }
//            }
//        });
//    }
...
//                newQuiz.setOnClickListener(new MainQuizAdapter.ButtonClickListener());
//                viewPastResults.setOnClickListener(new MainQuizAdapter.ButtonClickListener());
//
...
//            else if (v == newQuiz) {
//                Intent intent = new Intent(v.getContext(), MainQuizAdapter.class);
...
//     */
//    private class QuizDBWriterTask extends AsyncTask<QuizVariables, Void, QuizVariables> {
//
//        @Override
...
//                opt3 = options.get(2);
//
//                ((MainQuizAdapter) getActivity()).loadView(question, quest, option1, opt1, option2, opt2, option3, opt3);
//            }
//
//            @Override
